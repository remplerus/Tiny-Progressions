...
public class RepairTablet extends ItemBase {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		tooltip.add(new TranslationTextComponent("tooltip.tablet_1").mergeStyle((TextFormatting.YELLOW)));
		tooltip.add(new TranslationTextComponent("tooltip.tablet_2").mergeStyle((TextFormatting.YELLOW)));
	}
}
