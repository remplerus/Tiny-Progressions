...
public class CorruptedShard extends ItemBase {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip,	ITooltipFlag flagIn) {
		tooltip.add(new TranslationTextComponent("tooltip.warning_1").mergeStyle((TextFormatting.YELLOW)));
		tooltip.add(new TranslationTextComponent("tooltip.shard_1").mergeStyle((TextFormatting.YELLOW)));
	}
}
