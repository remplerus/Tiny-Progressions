...
public class SmallBandage extends ItemBase {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		tooltip.add(new TranslationTextComponent("tooltip.bandage_1").mergeStyle((TextFormatting.YELLOW)));
		tooltip.add(new TranslationTextComponent("tooltip.bandage_2").mergeStyle((TextFormatting.YELLOW)));
