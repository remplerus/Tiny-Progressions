...
public class BlockFluidVasholine extends FlowingFluidBlock {
	...
	public BlockFluidVasholine(Properties props) {
		super(TechBlocks.vasholine_fluid, props.doesNotBlockMovement().hardnessAndResistance(100.0F).noDrops()
				//.lightValue(15)
				.tickRandomly());
	}
...
//	}	
   ...
   public IParticleData getDripParticleData() {
    ...
    public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
    	tooltip.add(new TranslationTextComponent("tooltip.vasholine_1").mergeStyle((TextFormatting.YELLOW)));
    }
}