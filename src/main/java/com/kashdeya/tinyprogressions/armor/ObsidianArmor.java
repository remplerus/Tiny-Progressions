...
public class ObsidianArmor extends BaseArmor {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        if (ArmorHandler.obsidian_armor && ArmorHandler.obsidian_armor_resistance) {
        	tooltip.add(new TranslationTextComponent("tooltip.obsidianarmor_1").mergeStyle((TextFormatting.YELLOW)));
        	tooltip.add(new TranslationTextComponent("tooltip.obsidianarmor_2").mergeStyle((TextFormatting.YELLOW)));
        }
    }
}